...
First release. This release corrects the model response, which was
physically wrong and prevented the shipped pipeline from running at all.
...
[1.0.0]: https://github.com/skymanbp/splice-loss-model/releases/tag/v1.0.0
